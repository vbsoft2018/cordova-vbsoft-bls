...
public class BluetoothSerialService {
    ...
    private synchronized void setType(int type) {
        ...
        mType = type;
        // Give the new state to the Handler so the UI Activity can update
        mHandler.obtainMessage(BluetoothSerial.MESSAGE_TYPE_CHANGE, type, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device, final String socketType) {
        ...
        if(mType==NOT_LISTEN){
            ...
            if (D) Log.d(TAG, "connected, DEVICE_NAME:" + BluetoothSerial.DEVICE_NAME);
            ...
            try {
                ...
                Bundle bundle = new Bundle();
                bundle.putString(BluetoothSerial.DEVICE_INFO, json.toString());
                msg.setData(bundle);
                mHandler.sendMessage(msg);
    ...
    private void connectionFailed() {
        ...
        if(mType==NOT_LISTEN){
            ...
            BluetoothSerialService.this.listen();
        }
    }
    ...
    private void connectionLost() {
        ...
        if(mType==NOT_LISTEN){
            ...
            Message msg = mHandler.obtainMessage(BluetoothSerial.MESSAGE_RE_LISTEN);
            Bundle bundle = new Bundle();
            msg.setData(bundle);
            mHandler.sendMessage(msg);
            BluetoothSerialService.this.listen();
